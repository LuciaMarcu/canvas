...
class PrintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create print" do
    assert_difference('Print.count') do
      post prints_url, params: { print: { description: @print.description, title: @print.title, user_id: @print.user_id } }
    end
  ...
  test "should update print" do
    patch print_url(@print), params: { print: { description: @print.description, title: @print.title, user_id: @print.user_id } }
