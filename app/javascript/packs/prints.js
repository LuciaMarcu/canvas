	...
	var Prints = {
		previewPrint() {
			if (window.File && window.FileList && window.FileReader) {
				...
				const fileInput = document.getElementById('print_user_print');
				const previewImage = document.getElementById('previewImage');
				const newPrintForm = document.getElementById('new_print');
		...
		printHover() {
			$('.print').hover(function() {
				$(this).children('.print-data').toggleClass('visible');
			});
		}
